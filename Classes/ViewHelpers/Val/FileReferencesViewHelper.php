...
/**
 * Class FileReferencesViewHelper
 *
 * @package EssentialDots\ExtbaseFal\ViewHelpers\Val
 * @author Nikola Stojiljkovic
 */
class FileReferencesViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper {
	 ...
	 */
	public function render($foreignUid, $tableName, $fieldName) {
		$result = NULL;
		$value = $this->fileReferenceRepository->findByForeignUid($foreignUid, $tableName, $fieldName);
